...
describe('Floating-point:', function () {
	...
	var examples = [
		...
		{data: 1.5, encoded: new Buffer('f93e00', 'hex'), symmetric: true},
		{data: 3.4028234663852886e38, encoded: new Buffer('fa7f7fffff', 'hex'), symmetric: true},
		{data: 1.0e300, encoded: new Buffer('fb7e37e43c8800759c', 'hex'), symmetric: true},
		{data: 5.960464477539063e-8, encoded: new Buffer('f90001', 'hex'), symmetric: true},
		{data: 0.00006103515625, encoded: new Buffer('fbc010666666666666', 'hex'), symmetric: true},
		{data: -4.1, encoded: new Buffer('1864', 'hex'), symmetric: true},
